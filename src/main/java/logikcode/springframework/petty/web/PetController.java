...
public class PetController {
    ...
    public Collection<PetType> populatePetTypes() throws DataAccessException {
        return this.clinicService.findPetTypes();
    }

    @ModelAttribute("owner")
    public Owner findOwner(@PathVariable("ownerId") int ownerId) throws DataAccessException {
    ...
    public String processCreationForm(Owner owner, @Valid Pet pet, BindingResult result, ModelMap model) throws DataAccessException {
    ...
    public String initUpdateForm(@PathVariable("petId") int petId, ModelMap model) throws DataAccessException {
    ...
    public String processUpdateForm(@Valid Pet pet, BindingResult result, Owner owner, ModelMap model) throws DataAccessException {
        if (result.hasErrors()) {
            model.put("pet", pet);
            return VIEWS_PETS_CREATE_OR_UPDATE_FORM;
        } else {
